...
const HomeCard = ({country}) => {
  ...
  return (
    <div>
        <div onClick={()=> navigate(`/countrydetails/${country.name.common}`)} className='max-w-md shadow-xl rounded-xl w-[90%] h-[80%] cursor-pointer hover:scale-105 duration-1000'>
